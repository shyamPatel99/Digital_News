...
const News = (props) => {
  ...
  //count: !props.simplified ? 6 : 15
  //newsCategory:'Cryptocurrency'

  //offline Global News data
  ...
  const {data:cryptoNews} = useGetCryptoNewsQuery({ newsCategory:'global', count:props.simplified ? 6 : 20 });
  ...
  //console.log("Global New :",cryptoNews.value);
  return (
    <>
