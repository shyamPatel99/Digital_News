...
const IndiaNews = (props) => {
    ...
    const getLocalSports = () => {
        axios.get('http://localhost:9000/news/India')
            .then(response => {                
    ...
    const {data:cryptoNews} = useGetCryptoNewsQuery({ newsCategory:'india', count:props.simplified ? 6 : 20 });
    ...
    //console.log("India News :",cryptoNews.value);
    //paging
