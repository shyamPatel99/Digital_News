...
const BusinessNews = (props) => {
    ...
    const getLocalSports = () => {
        axios.get('http://localhost:9000/news/Business')
            .then(response => {                
    ...
    const {data:cryptoNews} = useGetCryptoNewsQuery({ newsCategory:'business', count:props.simplified ? 6 : 20 });
    ...
    //console.log("Business News :",cryptoNews.value);
  return (
    <>
        <Row gutter={[24,24]} >
            {displayNews}
